  ...
  <form role="form" action="<?php echo WEB_ROOT; ?>api/process.php?cmd=book" method="post">
    <div class="box-body">
	  ...
	  <div class="form-group">
		...
		<span id="sprytf_roomnumber">
        <textarea name="roomnumber" class="form-control input-sm" placeholder="Room Number" id="roomnumber"></textarea>
		<span class="textareaRequiredMsg">Room number is required.</span>
